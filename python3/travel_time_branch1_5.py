...
class Tracer_Travel_Time(W2_Contour):
    ...
    def travel_time_full_branch(self, initialBranch=1, write2shp=False):
        """
        ...
        Ttime1 = self.travel_time(endtime=endtime, branchID=1)
        ...
        Ttime5 = self.travel_time(endtime=endtime, branchID=5)
...
if __name__ == "__main__":
    ...
    TTT.travel_time_full_branch(initialBranch=1, write2shp=False)
