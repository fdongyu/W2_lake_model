...
if __name__ == "__main__":
    ...
    wdir = r'M:\Projects\0326\099-09\2-0 Wrk Prod\Dongyu_work\spill_modeling\particle_tracking_test\20191209_1422_test12'
    WPT = W2_Particle_Tracking(wdir)
    WPT.VisParticles(0, branchID=1, PlotGrid=True)
